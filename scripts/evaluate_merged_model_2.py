...
# CONFIGURATION
# ============================================================
MODEL_PATH  = "runs/detect/newcastle_v6_merged/weights/best.pt"   # BEST MODEL (48.2% mAP)
DATASET_DIR = Path("data/Newcastle-Traffic-Detection.v6_merged")   # 5-class merged dataset
TEST_DIR    = DATASET_DIR / "test"
RESULTS_DIR = Path("data/results_v6_merged")                       # FINAL RESULTS DIR
